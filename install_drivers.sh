...
# Drivers/documentação vivem sob doc/<câmera>/ (reorganização 2026-06).
# e-CAM82 IMX485 (MIPI) — pacote CORRETO para a câmera deste projeto
ECAM82_IMX485_DIR="${SCRIPT_DIR}/doc/e-CAM82/e-CAM82_CUOAGX_JETSON_XAVIER_ORIN_L4T35.2.1_13-MAR-2023_R02_RC1/e-CAM82_CUOAGX_JETSON_XAVIER_ORIN_L4T35.2.1_13-MAR-2023_R02"

# Pacotes GMSL — OUTROS produtos, mantidos apenas por referência
GMSL_OCTA_DIR="${SCRIPT_DIR}/doc/e-CAM82/e-CAM82_CUOAGX_L4T36.4.3/e-CAM_YUV-OCTA-GMSL-PRODUCTS_JETSON_AGX_ORIN_L4T36.4.3_10-FEB-2025_R02"
NILECAM81_DIR="${SCRIPT_DIR}/doc/NileCAM81/NileCAM81_CUOAGX/JP6.0_L4T36.3.0/e-CAM_YUV-GMSL-PRODUCTS_JETSON_AGX_ORIN_L4T36.3.0_09-AUG-2024_R03"
